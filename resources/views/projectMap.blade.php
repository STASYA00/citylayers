...
@php  $configs = ProjectController::getConfig($project_id);@endphp
@php  $projects = ProjectController::getProject($project_id);@endphp
@php
...
<div class="main-map">
    ...
    <script>
        ...
        <?php require_once("js/parser/category.js");?>
        <?php require_once("js/parser/subcategory.js");?>    
        <?php require_once("js/parser/config.js");?>
        <?php require_once("js/parser/projectimage.js");?>
        <?php require_once("js/parser/partner.js");?>
        <?php require_once("js/parser/award.js");?>
        <?php require_once("js/parser/project.js");?>
        <?php require_once("js/parser/team.js");?>
    ...
    <script>
        ...
        let subcats = SubcategoryParser.makeAll(subcategoryInput);
        let categories = CategoryParser.makeAll(categoryInput, subcats);
        let config = ConfigParser.make(configInput, categories);
                
        
        let project = ProjectParser.make(projectInput, config);
        ...
        let c = new CityLayersPanel(leftContainer);
        ...
        CityLayersPanel.switch(project.config)
