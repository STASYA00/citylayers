...
class ProjectCardInfo extends CategoryHeader{
...
class ProjectTeam extends CategoryHeader{
...
class TeamPersonInfo extends CategoryHeader{
...
class ProjectPeriodInfo extends CategoryHeader{
...
class Recognition extends CategoryHeader{
    constructor(parent, id, content){
        super(parent, id, content);
        this.name = id;
        this.content = content;
